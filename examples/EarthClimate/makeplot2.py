...
def comp2huybers(plname, xrange=False, show=True):
    ...
    c = plt.contourf(
        -1*body.Time / 1e6, lats[lats > 40*u.deg], temp.T[lats > 40*u.deg].value, 20 
    )
    plt.ylabel("Latitude")
   ...
   # plot ice height
    ...
    c = plt.contourf(
        -1*body.Time / 1e6, lats[lats > 40 * u.deg].value, ice.T[lats > 40 * u.deg, :].value, 20
    )
    plt.ylabel("Latitude")
    plt.ylim(40, 83)
    ...
    c = plt.contourf(
        -1*body.Time / 1e6, lats[lats > 40 * u.deg].value, acc.T[lats > 40 * u.deg].value, 20
    )
    plt.ylabel("Latitude")
    plt.ylim(40, 83)
    plt.yticks([40, 50, 60, 70, 80])
    ...
    c = plt.contourf(
        -1*body.Time / 1e6, lats[lats > 40 * u.deg].value, -abl.T[lats > 40 * u.deg].value, 20
    )
    plt.ylabel("Latitude")
    plt.ylim(40, 83)
    plt.yticks([40, 50, 60, 70, 80])
    ...
    plt.plot(
        ...
        linestyle="solid",
        marker="None",
        color='b', #vplot.colors.dark_blue,
        linewidth=2,
    )
    ...
    plt.plot(
        ...
        linestyle="solid",
        marker="None",
        color='purple', #vplot.colors.purple,
        linewidth=2,
    )
...
def seasonal_maps(time, show=True):
    ...
    plt.ylim(lats[0].value, lats[-1].value)
